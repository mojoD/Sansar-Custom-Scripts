...
public class BeatBlockRaver : SceneObjectScript
{
    ...
    private const int numTracks = 10;
   ...
   // public interface SendGenre
   // {
   //     List<string> SendGenreMessages { get; }
   // }

   // private void getGenre(ScriptEventData gotGenre)
   // {
   //     if (gotGenre.Data == null)
   //     {
   //         return;
   //     }
   //     SendGenre sendGenre = gotGenre.Data.AsInterface<SendGenre>();
   //     if (sendGenre == null)
   //     {
   //         Log.Write(LogLevel.Error, Script.ID.ToString(), "Unable to create interface, check logs for missing member(s)");
   //         return;
   //     }
   //     //Log.Write("Raver sendGenreMessageCount: " + sendGenre.SendGenreMessages.Count());
   //     if (sendGenre.SendGenreMessages[2] == "display") 
   //     {
   //         string newGenre;
   //         newGenre = sendGenre.SendGenreMessages[0];
   //         //Log.Write("Raver: Subscribed Genre Message = Genre: " + sendGenre.SendGenreMessages[0] + " Floor: " + sendGenre.SendGenreMessages[1] + " MoveType: " + sendGenre.SendGenreMessages[2]);
   //         //Log.Write("Raver New Genre: " + newGenre + " oldGenre: " + oldGenre);
   //         SendActiveBins sendActiveBins = new SendActiveBins();
   //         sendActiveBins.ActiveBin = new List<string>();
   //         //Log.Write("A1");
   //         sendActiveBins.SendActiveBin.Add(oldGenre);
  //          //sendActiveBins.SendActiveBin[0] = oldGenre;
   //         //Log.Write("Raver sendActiveBins.SendActiveBin[0]: " + sendActiveBins.SendActiveBin[0]);
   //         oldGenre = newGenre;
   //         //Log.Write("Raver BeatBlocksRaver oldGenre after set: " + oldGenre);
   //         if (sendActiveBins.SendActiveBin[0] != "FirstOne")
   //         {
   //             //Log.Write("Raver: Posting ReturnGenreBlock Message = Genre: " + sendActiveBins.SendActiveBin[0]);
   //             PostScriptEvent(ScriptId.AllScripts, "ReturnGenreBlock", sendActiveBins);
    //        }
    //    }
    //}
    ...
    {
        Log.Write("Raver: Script Started");
