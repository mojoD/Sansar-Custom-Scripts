...
public class RandomPrizeSelector : SceneObjectScript

{
    ...
    [DefaultValue("NextContestant")]
    [DisplayName("Next Contestant Event")]
    public string NextContestantEvent = "NextContestant";
    ...
    */
    ...
    public override void Init()
    {
        ...
        SubscribeToScriptEvent(NextContestantEvent, GetNextContestant);
    ...
    public void GetNextContestant(ScriptEventData data)
    {
        try
        {
            Log.Write("In GetNextContestant");
            PeopleInRange = 0;
    ...
    private void GivePrize(ScriptEventData data)
    {
