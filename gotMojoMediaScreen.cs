...
public class GotMojoMediaScreen : SceneObjectScript
{
            ...
            if (DataCmdIn.Contains("/play"))
            {
                ...
                switch (DataCmdIn.Trim())
                {
                    case "/play1":
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play1");
                        break;
                    case "/play2":
                        if (Play2.Length > 0)
                        {
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play2");
                        break;
                    case "/play3":
                        if (Play3.Length > 0)
                        {
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play3");
                        break;
                    case "/play4":
                        if (Play4.Length > 0)
                        {
                    ...
                    case "/play5":
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play5");
                        break;
                    case "/play6":
                        if (Play6.Length > 0)
                        {
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play6");
                        break;
                    case "/play7":
                        if (Play7.Length > 0)
                        {
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play7");
                        break;
                    case "/play8":
                        if (Play8.Length > 0)
                        {
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play8");
                        break;
                    case "/play9":
                        if (Play9.Length > 0)
                        {
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play9");
                        break;
                    case "/play10":
                        if (Play10.Length > 0)
                        {
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play10");
                        break;
                    case "/play11":
                        if (Play11.Length > 0)
                        {
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play11");
                        break;
                    case "/play12":
                        if (Play12.Length > 0)
                        {
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play12");
                        break;
                    case "/play13":
                        if (Play13.Length > 0)
                        {
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play13");
                        break;
                    case "/play14":
                        if (Play14.Length > 0)
                        {
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play14");
                        break;
                    case "/play15":
                        if (Play15.Length > 0)
                        {
                        ...
                        else ScenePrivate.Chat.MessageAllUsers("No Video in Slot Play15");
                        break;
                    default:
