...
public class Beats : SceneObjectScript
{
        ...
        do
        {
            ...
            if (cmdline.Contains("notes"))
            {
                ...
                if (cmdline.Contains("["))
                {
                    ...
                    //TempNotes.Add(strNotes);  //first note
    ...
    private void OnCollide(CollisionData Data)
    {
        ...
        {
            Log.Write(LogLevel.Info, "has entered my volume!");
    ...
    private void GetChatCommand(ChatData Data)
    {
        ...
        if (Data.Message.Contains("/"))
        {
            ...
            if (Data.Message.Contains("/loop"))
            {
                ...
                else if (Data.Message.Contains("sample("))
                {
                    ...
                    if (Data.Message.Contains("pan(")) SoundPos[loopNum] = BuildPan(Data.Message);
                    ...
                    {
                        strErrors = true;
                        Log.Write("Sample Not Found");  // Write back to Chat Window Eventually
                    }
                ...
                else if (Data.Message.Contains("inst("))
                {
                    ...
                    Log.Write("TrackNotes Count: " + TrackNotes[loopNum].Count);
                    ...
                    if (!strErrors)
                    {
                        ...
                        do
                        {
                            ...
                            {
                                strErrors = true;
                                Log.Write("Instrument Not Found");  // Write back to Chat Window Eventually
                            }
                            else
                            {
        ...
        if (Data.Message.Contains("memory"))
        {
