...
public class CustomCircularHotSpotsVRTouch : SceneObjectScript

{
    ...
    public override void Init()
    {
        ...
        SubscribeToAll("VR", InitializeComplexVRInteraction);
        SubscribeToScriptEvent("VRControllerInfo", getVRControllerInfo);

    }

    private void InitializeComplexVRInteraction(ScriptEventData data)
    {
    ...
    private void getVRControllerInfo(ScriptEventData gotVRControllerInfo)
    {
        ...
        Log.Write("HotSpot Received VRAgent: " + VRAgent + " VRController: " + VRController + " LocalPos: " + VRControllerLocalPosition + " WorldPos: " + VRControllerWorldPosition);

        //Interact with hot spots calls go here
        ExecuteInteraction(VRControllerWorldPosition);
    ...
    private void ComplexVRInteractionHandler()
    {
        /*
    ...
    private void ExecuteInteraction(Vector hitPosition)
    {
        //loopNote = false;
