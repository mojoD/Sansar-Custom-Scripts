...
public class CustomPanicButton : SceneObjectScript

{
    #region ConstantsVariables
    public readonly Interaction PanicInteraction;
    ...
    {
        PanicInteraction.Subscribe((InteractionData idata) =>
        {
    ...
    private void ExecuteInteraction(InteractionData idata)
    {
        ...
        SendToAll(PanicEvent, sd);
        Wait(TimeSpan.FromSeconds(2));
        SendToAll(PanicEvent+"Off", sd);
    }
