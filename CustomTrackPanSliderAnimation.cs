...
public class CustomTrackPanSliderAnimation : SceneObjectScript
{
    #region EditorProperties
    public int SliderNumber = 0;
    ...
    private void getVolumeStripInfo(ScriptEventData gotVolumeStripInfo)
    {
        ...
        if (trackStripNumber == SliderNumber)
        {
            animation.JumpToFrame(trackStripPosition);
        }
    }
    ...
    public override void Init()
    {
        ...
        SubscribeToScriptEvent("PanPosition", getVolumeStripInfo);
    }
