...
public class CustomSecuritySender : SceneObjectScript

{
    ...
    [DefaultValue("StartLooper")]
    [DisplayName("Event to Send Security:")]
    public string StartEvent = "StartLooper";
    ...
    private void SendSecurity(ScriptEventData sed)
    {
        SendSampleInfoSelected(UsersToListenTo);
    }

    public class SendSecurityInfo : Reflective
    {
    ...
    private void SendSampleInfoSelected(string SecurityList)
    {
        SendSecurityInfo sendSecurityInfo = new SendSecurityInfo();
        sendSecurityInfo.SecurityString = UsersToListenTo;
        PostScriptEvent(ScriptId.AllScripts, "SecurityList", sendSecurityInfo);
        //Log.Write("CustomSecuritySender - UsersToListenTo: " + UsersToListenTo);
    }
