...
public class CustomBPMSliderAnimation : SceneObjectScript
{
    ...
    private void getBPMStripInfo(ScriptEventData gotBPMStripInfo)
    {
        ...
        int BPMPosition = sendBPMStripInfo.BPMStripPosition;
        Log.Write("BPM Passed: " + BPMPosition);

        animation.JumpToFrame(BPMPosition);
