...
#if (SansarBuild)
public class StandAlonePiano : SceneObjectScript
#endif
#if (StandAloneBuild)
public class Beats
#endif
{
    ...
    private string StandAloneInstrument = "piano";
    private string WelcomeMessage = "Welcome to the Interactive Grand Piano";
    ...
    private PlayHandle[] playHandle = new PlayHandle[numTracks];
    ...
    private void OnCollide(CollisionData Data)
    {
        ...
        if (Data.Phase == CollisionEventPhase.TriggerEnter)
        {
            ...
            Jammer = hit.AgentInfo.SessionId;
    ...
    private void getInstrument(ScriptEventData gotInstrument)
    {
        ...
        {
            string DefaultInstrument = "/jam inst(" + StandAloneInstrument + ") scale(c2, chromatic) octaves(4)";
    ...
    void CommandReceived(CommandData Button)
    {
        ...
        if ((Button.Command == "Action1") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(1);
        else if ((Button.Command == "Action2") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(2);
        else if ((Button.Command == "Action3") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(3);
        else if ((Button.Command == "Action4") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(4);
        else if ((Button.Command == "Action5") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(5);
        else if ((Button.Command == "Action6") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(6);
        else if ((Button.Command == "Action7") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(7);
        else if ((Button.Command == "Action8") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(8);
        else if ((Button.Command == "Action9") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(9);
        else if ((Button.Command == "Action0") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(10);
        else if ((Button.Command == "Keypad0") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(11);
        else if ((Button.Command == "Keypad1") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(12);
        else if ((Button.Command == "Keypad2") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(13);
        else if ((Button.Command == "Keypad3") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(14);
        else if ((Button.Command == "Keypad4") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(15);
        else if ((Button.Command == "Keypad5") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(16);
        else if ((Button.Command == "Keypad6") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(17);
        else if ((Button.Command == "Keypad7") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(18);
        else if ((Button.Command == "Keypad8") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(19);
        else if ((Button.Command == "Keypad9") && (Button.Action == CommandAction.Pressed) && (!(Shifted))) PlayJam(20);
        else if ((Button.Command == "Action1") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(21);
        else if ((Button.Command == "Action2") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(22);
        else if ((Button.Command == "Action3") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(23);
        else if ((Button.Command == "Action4") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(24);
        else if ((Button.Command == "Action5") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(25);
        else if ((Button.Command == "Action6") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(26);
        else if ((Button.Command == "Action7") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(27);
        else if ((Button.Command == "Action8") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(28);
        else if ((Button.Command == "Action9") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(29);
        else if ((Button.Command == "Action0") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(30);
        else if ((Button.Command == "Keypad0") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(31);
        else if ((Button.Command == "Keypad1") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(32);
        else if ((Button.Command == "Keypad2") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(33);
        else if ((Button.Command == "Keypad3") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(34);
        else if ((Button.Command == "Keypad4") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(35);
        else if ((Button.Command == "Keypad5") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(36);
        else if ((Button.Command == "Keypad6") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(37);
        else if ((Button.Command == "Keypad7") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(38);
        else if ((Button.Command == "Keypad8") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(39);
        else if ((Button.Command == "Keypad9") && (Button.Action == CommandAction.Pressed) && (Shifted)) PlayJam(40);
    ...
    private void PlaySansar(float LoudnessIn, float PitchShiftIn, int PlayIndexIn, int LoopIn2)
    {
    ...
    private void PlayJam(int playIndex)
    {
        int loopIn = loopNum;
        TrackPitchShift[loopIn] = TrackOffsets[loopIn][playIndex-1];
        PlaySansar(TrackVolume[loopIn], TrackPitchShift[loopIn], playIndex-1, loopIn);
    }
...
#region Tracks
    ...
    private void Panic()
    {
        ...
        do
        {
            Log.Write("Stopping Track " + loopNum);
            if (TrackRunning[loopcntr])
            {
                Log.Write("Track Running");
                playHandle[loopcntr].Stop();
                loopcntr++;
            }
...
#region CommandParser
    private void ParseCommands(string DataCmdIn)
    {
        ...
        {
            DataCmdIn = "/jam inst(" + StandAloneInstrument + ") scale(c2, chromatic) octaves(4)";
