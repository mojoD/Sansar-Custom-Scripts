...
public class CustomLaserLightController : SceneObjectScript

{
    ...
    {
        Log.Write("In CustomLaserLightController");
    ...
    public void SendLaserType(string LaserTypeSelected)
    {
        LaserTypeInfo sendLaserTypeInfo = new LaserTypeInfo();
        sendLaserTypeInfo.LaserID = "ALL";
    ...
    public void SendBlinkInfo(bool currentBlink)
    {
        BlinkInfo sendBlinkInfo = new BlinkInfo();
        sendBlinkInfo.LaserID = "ALL";
    ...
    public void SendBlinkRateInfo(float currentBlinkRate)
    {
        BlinkRateInfo sendBlinkRateInfo = new BlinkRateInfo();
        sendBlinkRateInfo.LaserID = "ALL";
    ...
    public void SendWorldPosInfo(int PositionIndex)
    {
        WorldPosInfo sendWorldPosInfo = new WorldPosInfo();
        sendWorldPosInfo.LaserID = "ALL";
    ...
    private void SendLaserCommand(string controlSurface, InteractionData idata)
    {
        ...
        else
        {
            ...
            {
                case "R1C1": SendLaserType("RedLaser"); break;
                case "R2C1": SendLaserType("GreenLaser"); break;
                case "R3C1": SendLaserType("BlueLaser"); break;
                case "R4C1": SendLaserType("BeamLaser"); break;
                case "R5C1": SendLaserType("NoLaser"); break;
                case "R1C2": SendBlinkInfo(true); break;
                case "R2C2": SendBlinkInfo(false); break;
                case "R3C2": SendBlinkRateInfo(-0.1f); break;
                case "R4C2": SendBlinkRateInfo(0.1f); break;
                case "R1C3": SendRelPosInfo("X", "+"); break;
                case "R2C3": SendRelPosInfo("Y", "+"); break;
                case "R3C3": SendRelPosInfo("Z", "+"); break;
                case "R4C3": SendWorldPosInfo(1); break;
                case "R5C3": SendWorldRotInfo(1); break;
                case "R1C4": SendRelPosInfo("X", "-"); break;
                case "R2C4": SendRelPosInfo("Y", "-"); break;
                case "R3C4": SendRelPosInfo("Z", "-"); break;
                case "R4C4": SendWorldPosInfo(2); break;
                case "R5C5": SendWorldRotInfo(2); break;
                case "R1C6": SendFullSpin("NoSpin"); break;
                case "R2C6": SendPanAngle("X", 10.0f); break;
                case "R3C6": SendPanAngle("Y", 10.0f); break;
                case "R4C6": SendPanAngle("Z", 10.0f); break;
                case "R5C6": SendPanRate(-0.1f); break;
                case "R1C7": SendFullSpin("PanSpin"); break;
                case "R2C7": SendPanAngle("X", -10.0f); break;
                case "R3C7": SendPanAngle("Y", -10.0f); break;
                case "R4C7": SendPanAngle("Z", -10.0f); break;
                case "R5C7": SendPanRate(0.1f); break;
                case "R1C8": SendFullSpin("FullSpin"); break;
                case "R2C8": SendSpinRate(0.1f); break;
                case "R3C8": SendSpinRate(-0.1f); break;
                case "R4C8": SendSpinAngle(15.0f); break;
                case "R5C8": SendSpinAngle(-15.0f); break;
            }
        }
    }
