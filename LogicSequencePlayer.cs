...
public class LogicSequencePlayer : SceneObjectScript

{
    ...
    private void PlaySequence(ScriptEventData data)
    {
        ...
        foreach (string SequenceElement in SequenceList)
        {
            ...
            sendSimpleMessage(SequenceName + SequenceElement);
            Wait(TimeSpan.FromMilliseconds(TimingList[cntr] * 1000));
            sendSimpleMessage(SequenceName + SequenceElement + "Off");
            cntr++;
        }
    }
